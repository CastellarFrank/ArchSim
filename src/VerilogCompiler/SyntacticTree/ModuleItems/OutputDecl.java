 ...
 */
public class OutputDecl extends ModuleItem{
    Range range;
    ArrayList<Variable> variableList;

    public OutputDecl(Range range, ArrayList<Variable> variableList, int line, int column) {
        super(line, column);
        this.range = range;
    ...
    public String toString() {
        return String.format("output %s %s;", range==null?"":range.toString(), 
    ...
    public VNode getCopy() {
        ...
        return new OutputDecl(newRange, vars, line, column);
    }
